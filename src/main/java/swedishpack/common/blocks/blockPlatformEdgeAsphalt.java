...
public class blockPlatformEdgeAsphalt extends BlockContainer {

    public blockPlatformEdgeAsphalt(){
        super (Material.rock);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((tilePlatformEdgeAsphalt)world.getTileEntity(x,y,z)).dir){
    ...
    public TileEntity createNewTileEntity(World world, int i) {
        return new tilePlatformEdgeAsphalt();
    }
  ...
  //  }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack)
    {
        ...
        tilePlatformEdgeAsphalt tile = new tilePlatformEdgeAsphalt(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3);
