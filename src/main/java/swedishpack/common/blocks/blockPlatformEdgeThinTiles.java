...
public class blockPlatformEdgeThinTiles extends BlockContainer {

    public blockPlatformEdgeThinTiles(){
        super (Material.rock);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((tilePlatformEdgeThinTiles)world.getTileEntity(x,y,z)).dir){
    ...
    public TileEntity createNewTileEntity(World world, int i) {
        return new tilePlatformEdgeThinTiles();
    }
  ...
  //  }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack)
    {
        ...
        tilePlatformEdgeThinTiles tile = new tilePlatformEdgeThinTiles(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3);
