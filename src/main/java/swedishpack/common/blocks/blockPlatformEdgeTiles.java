...
public class blockPlatformEdgeTiles extends BlockContainer {

    public blockPlatformEdgeTiles(){
        super (Material.rock);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((tilePlatformEdgeTiles)world.getTileEntity(x,y,z)).dir){
    ...
    public TileEntity createNewTileEntity(World world, int i) {
        return new tilePlatformEdgeTiles();
    }
  ...
  //  }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack)
    {
        ...
        tilePlatformEdgeTiles tile = new tilePlatformEdgeTiles(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3);
