...
import swedishpack.common.library.AddonPackBlocks;
...
public class SwedishPack
{
    ...
    @SidedProxy(clientSide = "swedishpack.client.core.ClientProxy", serverSide = "swedishpack.common.core.CommonProxy")
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        AddonPackBlocks addonPackBlocks = new AddonPackBlocks();
