...
public class Swedish_PackEntityLocoElectricSJLittRc1 extends ElectricTrain {
	...
	public static final SoundRecord Sound = new SoundRecord(Swedish_PackEntityLocoElectricSJLittRc1.class, Swedish_PackAddonInfo.resourceLocation + ":signalhornlong", 0.8F, Info.resourceLocation +":vl10_idle", 0.2F, 50, Info.resourceLocation +":vl10_idle" , 0.2F, 50, false, Info.resourceLocation +" ", 0 );
		...
		setCargoManager(new CargoManager(new CargoSpecification[][]
			{
				{ new CargoSpecification(ModelRcPanto.class,
						Swedish_PackAddonInfo.modID, "Rc_Panto", "Rc_Diamond_AllUp",
		...
		Traincraft.traincraftRegistry.RegisterRollingStockModel(new TrainRenderRecord(Swedish_PackAddonInfo.modID,
			...
			public ResourceLocation getTextureFile(String colorAsString) {
				...
				switch (colorAsString.toLowerCase()) {
					case "yellow":
						texturePath = "textures/trains/Rc1_/Rc1_sjo2vm_AllDown";
						break;
					case "blue":
						texturePath = "textures/trains/Rc1_/Rc1_sjo2vm_BackUp";
						break;
					case "green":
						texturePath = "textures/trains/Rc1_/Rc1_sjo2vm_FrontUp";
						break;
					case "red":
						texturePath = "textures/trains/Rc1_/Rc1_sjo2vm_AllUp";
						break;
					case "black":
