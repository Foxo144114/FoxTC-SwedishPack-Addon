...
public class Swedish_PackEntityLocoElectricSJLittDm extends ElectricTrain {
	...
	public static final SoundRecord Sound = new SoundRecord(Swedish_PackEntityLocoElectricSJLittDm.class, Swedish_PackAddonInfo.resourceLocation + ":signalhornlong", 0.3F, Info.resourceLocation +":vl10_idle", 0.2F, 50, Info.resourceLocation +":vl10_idle" , 0.2F, 50, false, Swedish_PackAddonInfo.resourceLocation + ":signalhornshort", 30  );
