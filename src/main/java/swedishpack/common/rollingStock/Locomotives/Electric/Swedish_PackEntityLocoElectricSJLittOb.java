...
public class Swedish_PackEntityLocoElectricSJLittOb extends ElectricTrain {
	...
	public static final SoundRecord Sound = new SoundRecord(Swedish_PackEntityLocoElectricSJLittOb.class, Swedish_PackAddonInfo.resourceLocation + ":bwhistlelong", 0.3F, Info.resourceLocation +":vl10_idle", 0.2F, 50, Info.resourceLocation +":vl10_idle" , 0.2F, 50, false, Swedish_PackAddonInfo.resourceLocation + ":bwhistleshort", 30 );
	...
	public void setupTextureDescription() {
		InsertTexture(0, "Ob, No Plow");
		InsertTexture(1, "Ob, With Plow");
	}
