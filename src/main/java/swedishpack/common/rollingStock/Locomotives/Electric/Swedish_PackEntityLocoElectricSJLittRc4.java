...
public class Swedish_PackEntityLocoElectricSJLittRc4 extends ElectricTrain {
	...
	public static final SoundRecord Sound = new SoundRecord(Swedish_PackEntityLocoElectricSJLittRc4.class, Swedish_PackAddonInfo.resourceLocation + ":signalhornlong", 0.3F, Info.resourceLocation +":vl10_idle", 0.2F, 50, Info.resourceLocation +":vl10_idle" , 0.2F, 50, false, Swedish_PackAddonInfo.resourceLocation + ":signalhornshort", 30  );
		...
		Traincraft.traincraftRegistry.RegisterRollingStockModel(new TrainRenderRecord(Swedish_PackAddonInfo.modID,
			...
			public ResourceLocation getTextureFile(String colorAsString) {
				...
				switch (colorAsString.toLowerCase()) {
					case "yellow":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCG_Mno";
						break;
					case "blue":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCG_Mfo";
						break;
					case "green":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCG_Mbo";
						break;
					case "black":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCB_Mno";
						break;
					case "white":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCB_Mfo";
						break;
					case "grey":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCB_Mbo";
						break;
					case "magenta":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCO_Mno";
						break;
					case "lightblue":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCO_Mfo";
						break;
					case "lime":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_GCO_Mbo";
						break;
					case "lightgrey":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_Elektra_Mno";
						break;
					case "cyan":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_Elektra_Mfo";
						break;
					case "pink":
						texturePath = "textures/trains/Locomotives/Electric/Rc4_/Rc4_Elektra_Mbo";
						break;
