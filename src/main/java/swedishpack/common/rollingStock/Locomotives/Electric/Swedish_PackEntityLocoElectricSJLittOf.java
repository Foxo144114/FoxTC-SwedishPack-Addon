...
public class Swedish_PackEntityLocoElectricSJLittOf extends ElectricTrain {
	...
	public static final SoundRecord Sound = new SoundRecord(Swedish_PackEntityLocoElectricSJLittOf.class, Swedish_PackAddonInfo.resourceLocation + ":bwhistlelong", 0.3F, Info.resourceLocation +":vl10_idle", 0.2F, 50, Info.resourceLocation +":vl10_idle" , 0.2F, 50, false, Swedish_PackAddonInfo.resourceLocation + ":bwhistleshort", 30);
	...
	public void setupTextureDescription() {
		InsertTexture(0, "Of, A end, No Plow");
		InsertTexture(1, "Of, A end, With Plow");
		InsertTexture(2, "Of, B end, No Plow");
		InsertTexture(3, "Of, B end, With Plow");
		InsertTexture(4, "Of, Of3 Unit");
	}
	@Override
