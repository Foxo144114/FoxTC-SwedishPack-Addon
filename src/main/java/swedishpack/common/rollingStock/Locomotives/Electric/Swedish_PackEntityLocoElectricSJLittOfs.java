...
public class Swedish_PackEntityLocoElectricSJLittOfs extends ElectricTrain {
	...
	public static final SoundRecord Sound = new SoundRecord(Swedish_PackEntityLocoElectricSJLittOfs.class, Swedish_PackAddonInfo.resourceLocation + ":bwhistleshort", 0.3F, Info.resourceLocation +":vl10_idle", 0.2F, 50, Info.resourceLocation +":vl10_idle" , 0.2F, 50, false, Info.resourceLocation +" ", 0 );
