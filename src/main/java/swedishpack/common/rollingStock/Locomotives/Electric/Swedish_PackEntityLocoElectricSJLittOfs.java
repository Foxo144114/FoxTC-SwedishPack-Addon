...
public class Swedish_PackEntityLocoElectricSJLittOfs extends ElectricTrain {

	public static final SoundRecord Sound = new SoundRecord(Swedish_PackEntityLocoElectricSJLittOfs.class, Swedish_PackAddonInfo.resourceLocation + ":bwhistlelong", 0.3F, Info.resourceLocation +":vl10_idle", 0.2F, 50, Info.resourceLocation +":vl10_idle" , 0.2F, 50, false, Swedish_PackAddonInfo.resourceLocation + ":bwhistleshort", 30 );
	...
	public Swedish_PackEntityLocoElectricSJLittOfs(World world) {
		super(world);
	...
	public void setupTextureDescription() {
		InsertTexture(0, "Of, Shunter, No Plow");
		InsertTexture(1, "Of, Shunter, With Plow");
	}
	@Override
	...
	public void onRenderInsertRecord()
	{
		Traincraft.traincraftRegistry.RegisterRollingStockModel(new TrainRenderRecord(Swedish_PackAddonInfo.modID,
				Swedish_PackEntityLocoElectricSJLittOfs.class, new ModelSJLittOf(),
				"Of_",
				new float[] {-3.65F, -0.5F, 0.0F},
			...
			public ResourceLocation getTextureFile(String colorAsString) {
				...
				switch (colorAsString.toLowerCase()) {
					case "yellow":
						texturePath = "textures/trains/Locomotives/Electric/Of_/Of_Shunter/SJLittOf_SNP";
						break;
					case "blue":
						texturePath = "textures/trains/Locomotives/Electric/Of_/Of_Shunter/SJLittOf_SWP";
						break;
				}
				texturePath += ".png";
