		...
		setCargoManager(new CargoManager(new CargoSpecification[][]
			{
				{ new CargoSpecification(ModelTGOJLittBtPanto.class,
						Swedish_PackAddonInfo.modID, "trains/Bt_Panto/Bt_AllDown", "Pantograph All Down",
						new CargoSpecification.RenderParameters().setOffset(0,3.0,0))
				},
					{ new CargoSpecification(ModelTGOJLittBtPanto.class,

							Swedish_PackAddonInfo.modID, "trains/Bt_Panto/Bt_AllUp", "Pantograph All Up",
							new CargoSpecification.RenderParameters().setOffset(0,3.0,0))
					},
					{ new CargoSpecification(ModelTGOJLittBtPanto.class,
							Swedish_PackAddonInfo.modID, "trains/Bt_Panto/Bt_FrontUp", "Pantograph Front Up",
							new CargoSpecification.RenderParameters().setOffset(0,3.0,0))
					},
					{ new CargoSpecification(ModelTGOJLittBtPanto.class,
							Swedish_PackAddonInfo.modID, "trains/Bt_Panto/Bt_BackUp", "Pantograph Back Up",
							new CargoSpecification.RenderParameters().setOffset(0,3.0,0))
					}
		...
		Traincraft.traincraftRegistry.RegisterRollingStockModel(new TrainRenderRecord(Swedish_PackAddonInfo.modID,
			...
			public ResourceLocation getTextureFile(String colorAsString) {
				...
				switch (colorAsString.toLowerCase()) {
					case "yellow":
						texturePath = "textures/trains/Bt_/Bt_G_Mno";
						break;
					case "blue":
						texturePath = "textures/trains/Bt_/Bt_G_Mfo";
						break;
					case "green":
						texturePath = "textures/trains/Bt_/Bt_G_Mbo";
						break;
					case "black":
						texturePath = "textures/trains/Bt_/Bt_Gf_Mno";
						break;
					case "white":
						texturePath = "textures/trains/Bt_/Bt_Gf_Mfo";
						break;
					case "grey":
						texturePath = "textures/trains/Bt_/Bt_Gf_Mbo";
						break;
					case "magenta":
						texturePath = "textures/trains/Bt_/Bt_O_Mno";
						break;
					case "lightblue":
						texturePath = "textures/trains/Bt_/Bt_O_Mfo";
						break;
					case "lime":
						texturePath = "textures/trains/Bt_/Bt_O_Mbo";
						break;
					case "lightgrey":
						texturePath = "textures/trains/Bt_/Bt_Mo_Mno";
						break;
					case "cyan":
						texturePath = "textures/trains/Bt_/Bt_Mo_Mfo";
						break;
					case "pink":
						texturePath = "textures/trains/Bt_/Bt_Mo_Mbo";
						break;
					case "purple":
						texturePath = "textures/trains/Bt_/Bt_SJO_Mno";
						break;
					case "brown":
						texturePath = "textures/trains/Bt_/Bt_SJO_Mfo";
						break;
					case "orange":
						texturePath = "textures/trains/Bt_/Bt_SJO_Mbo";
						break;
