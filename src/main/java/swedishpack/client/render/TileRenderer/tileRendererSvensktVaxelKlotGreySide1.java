...
public class tileRendererSvensktVaxelKlotGreySide1 extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation texture2 = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/GreySide1/SwedishSwitchStandKlotGreySide1On.png");
    private static final ResourceLocation texture = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/GreySide1/SwedishSwitchStandKlotGreySide1Off.png");
