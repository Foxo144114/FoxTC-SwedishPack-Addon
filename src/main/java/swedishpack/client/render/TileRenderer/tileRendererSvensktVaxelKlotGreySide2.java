...
public class tileRendererSvensktVaxelKlotGreySide2 extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation texture2 = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/GreySide2/SwedishSwitchStandKlotGreySide2On.png");
    private static final ResourceLocation texture = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/GreySide2/SwedishSwitchStandKlotGreySide2Off.png");
