...
public class tileRendererSvensktVaxelKlotGreenSide1 extends TileEntitySpecialRenderer {
    private static final ModelSvensktVaxelKlotOn modelSwitch2 = new ModelSvensktVaxelKlotOn();
    private static final ModelSvensktVaxelKlotOff modelSwitch = new ModelSvensktVaxelKlotOff();
    private static final ResourceLocation texture2 = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/GreenSide1/SwedishSwitchStandKlotGreenSide1On.png");
    private static final ResourceLocation texture = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/GreenSide1/SwedishSwitchStandKlotGreenSide1Off.png");
