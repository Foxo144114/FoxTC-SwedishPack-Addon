...
public class tileRendererSvensktVaxelKlotGreenSide2 extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation texture2 = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/GreenSide2/SwedishSwitchStandKlotGreenSide2On.png");
    private static final ResourceLocation texture = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/GreenSide2/SwedishSwitchStandKlotGreenSide2Off.png");
