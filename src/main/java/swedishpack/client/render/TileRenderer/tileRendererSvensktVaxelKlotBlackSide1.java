...
public class tileRendererSvensktVaxelKlotBlackSide1 extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation texture2 = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/BlackSide1/SwedishSwitchStandKlotBlackSide1On.png");
    private static final ResourceLocation texture = new ResourceLocation(Swedish_PackAddonInfo.resourceLocation,Swedish_PackAddonInfo.modelTexPrefix + "SvensktVaxelKlot/BlackSide1/SwedishSwitchStandKlotBlackSide1Off.png");
