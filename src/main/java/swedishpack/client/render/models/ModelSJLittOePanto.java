...
public class ModelSJLittOePanto extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelSJLittOePanto() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(15F, -37F, -4F);

		bodyModel[1].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Du loco part37
		bodyModel[1].setRotationPoint(15F, -37F, 3F);

		bodyModel[2].addBox(0F, 0F, 0F, 1, 1, 12, 0F); // Du loco part37
		bodyModel[2].setRotationPoint(16F, -38F, -6F);
		...
		bodyModel[3].setRotationPoint(16F, -38F, 6F);
		...
		bodyModel[4].setRotationPoint(16F, -38F, -8F);
		...
		bodyModel[5].setRotationPoint(4F, -35F, -5F);
		...
		bodyModel[6].setRotationPoint(4F, -36F, -4F);
		...
		bodyModel[7].setRotationPoint(20F, -35F, 4F);
		...
		bodyModel[8].setRotationPoint(18F, -37F, -4F);
		...
		bodyModel[9].setRotationPoint(4F, -35F, 4F);
		...
		bodyModel[10].setRotationPoint(4F, -36F, 3F);
		...
		bodyModel[11].setRotationPoint(20F, -35F, -5F);
		...
		bodyModel[12].setRotationPoint(17F, -36F, -4F);
		...
		bodyModel[13].setRotationPoint(20F, -40F, 4F);
		...
		bodyModel[14].setRotationPoint(7F, -40F, 4F);
		...
		bodyModel[15].setRotationPoint(17F, -46F, 3F);
		...
		bodyModel[16].setRotationPoint(7F, -46F, 3F);

		bodyModel[17].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Du loco part37
		bodyModel[17].setRotationPoint(15F, -47F, -4F);

		bodyModel[18].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Du loco part37
		bodyModel[18].setRotationPoint(15F, -47F, 3F);

		bodyModel[19].addBox(0F, 0F, 0F, 1, 1, 12, 0F); // Du loco part37
		bodyModel[19].setRotationPoint(16F, -48F, -6F);
		...
		bodyModel[20].setRotationPoint(16F, -48F, 6F);
		...
		bodyModel[21].setRotationPoint(16F, -48F, -8F);
		...
		bodyModel[22].setRotationPoint(20F, -40F, -5F);
		...
		bodyModel[23].setRotationPoint(7F, -40F, -5F);
		...
		bodyModel[24].setRotationPoint(17F, -46F, -4F);
		...
		bodyModel[25].setRotationPoint(7F, -46F, -4F);
		...
		bodyModel[26].setRotationPoint(18F, -46F, -4F);
		...
		bodyModel[27].setRotationPoint(18F, -46F, -4F);
		...
		bodyModel[28].setRotationPoint(17F, -36F, 3F);
		...
		bodyModel[29].setRotationPoint(18F, -37F, -4F);
	}
}